...
```{r ditributionOfScore, echo=FALSE}
...
```{r confidentIntervalChineseOther, echo=FALSE}
...
```{r permTestMeanChineseOther, echo=FALSE}
N <- 10^4-1
...
```{r confidentIntervalChineseAsian, echo=FALSE}
...
H_a: \mu_{Chinese} > \mu_{Asian}
$$  
```{r permTestMeanChineseAsian, echo=FALSE}
...
```{r permTestTrimmedMeanChineseAsian, echo=FALSE}
